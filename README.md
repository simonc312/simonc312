...
<div class="weather-right-card">
    <table class="weather-right__table" style="width:240px">
        ...
        <td class="weather-right__item weather-right__wind-speed">3.33mph</td>
        </tr>
        <tr class="weather-right-card__items">
        <td class="weather-right__item">💦Humidity</td>
        <td class="weather-right__item weather-right__humidity">99%</td>
        </tr>
        <tr class="weather-right__items">
        ...
        <td class="weather-right__item weather-right__sunset">07:14 PM</td>
        </tr>
    </tbody></table>
</div>
</div>
...
------------
<p align="center">Last refresh: Thursday, September 17, 5:13 AM PDT<br /></p>
