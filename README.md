...
<div class="weather-right-card">
    <table class="weather-right__table" style="width:240px">
        ...
        <td class="weather-right__item weather-right__wind-speed">3.13mph</td>
        </tr>
        <tr class="weather-right-card__items">
        <td class="weather-right__item">💦Humidity</td>
        <td class="weather-right__item weather-right__humidity">98%</td>
        </tr>
        <tr class="weather-right__items">
...
------------
<p align="center">Last refresh: Friday, September 11, 5:20 AM PDT<br /></p>
