...
<div class="weather-right-card">
    <table class="weather-right__table" style="width:240px">
        ...
        <td class="weather-right__item weather-right__feels">39°F</td>
        </tr>
        <tr class="weather-right__items">
        <td class="weather-right__item">🌪️Wind</td>
        <td class="weather-right__item weather-right__wind-speed">6.31mph</td>
        </tr>
        <tr class="weather-right-card__items">
        <td class="weather-right__item">💦Humidity</td>
        <td class="weather-right__item weather-right__humidity">96%</td>
        </tr>
        <tr class="weather-right__items">
...
------------
<p align="center">Last refresh: Wednesday, March 10, 4:15 AM PST<br /></p>
